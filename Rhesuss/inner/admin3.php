						...
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-sm-9 text-secondary">
									...
									<input  onclick="window.location.href='admin4.php'" type="button" class="btn btn-primary px-4" value="Edit Row">
                  <input  onclick="window.location.href='deletedr.php'" type="button" class="btn btn-primary px-4" value="Delete Row">
