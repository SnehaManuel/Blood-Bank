					...
					<div class="card"> 
						...
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-sm-9 text-secondary">
                                    <input  onclick="window.location.href='proupdate.php'" type="submit" class="btn btn-primary px-4" value="Save data" name="insert">
                                
									<input  onclick="window.location.href='profile.php'" type="button" class="btn btn-primary px-4" value="Go back without saving">
								</div>
							</div>
						</div>
                         </form>
