...
<div class="item" style = "Padding-top:20px;">
            <ul id="content-slider" class="content-slider">
                <li>
                    <img src="assets/img/myth/1.jpg" class="img-fluid" alt="">
                </li>
                <li>
                   <img src="assets/img/myth/2.jpg" class="img-fluid" alt="">
                </li>
                <li>
                  <img src="assets/img/myth/3.jpg" class="img-fluid" alt="">
                </li>
                <li>
                   <img src="assets/img/myth/4.jpg" class="img-fluid" alt="">
                </li>
                <li>
                   <img src="assets/img/myth/5.jpg" class="img-fluid" alt="">
                </li>
                 <li>
                   <img src="assets/img/myth/6.jpg" class="img-fluid" alt="">
                </li>
				 <li>
                   <img src="assets/img/myth/7.jpg" class="img-fluid" alt="">
                </li>
                <li>
                  <img src="assets/img/myth/8.jpg" class="img-fluid" alt="">
                </li>
                <li>
                   <img src="assets/img/myth/9.jpg" class="img-fluid" alt="">
                </li>
                <li>
                   <img src="assets/img/myth/10.jpg" class="img-fluid" alt="">
                </li>
